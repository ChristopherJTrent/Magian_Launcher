  ...
  const outputObject = {
    ...
    ffxi: {
      ...
      registry: {
        ...
        '0005': -1,
        '0006': -1,
        '0007': settings.gameSoundEnabled,
        '0008': -1,
        '0009': -1,
        '0010': -1,
        ...
        '0015': -1,
        '0016': -1,
        '0017': settings.bumpMapping,
        '0018': settings.textureCompression,
        '0019': settings.mapCompression,
        '0020': settings.animationFrameRate,
        '0021': settings.hardwareMouse,
        '0022': settings.openingMovie,
        '0023': settings.simpleCharacterCreation,
        '0024': -1,
        '0025': -1,
        '0026': -1,
        '0027': -1,
        ...
        '0030': settings.lcdMode,
        '0031': -1,
        '0032': -1,
        '0033': -1,
        '0034': settings.windowMode,
        '0035': settings.backgroundSounds,
        '0036': settings.fontCompression,
        '0037': settings.menuResolutionX,
        '0038': settings.menuResolutionY,
        '0039': settings.imeMode,
        '0040': settings.graphicsStabilization,
        '0041': settings.betaUI,
        '0042': -1,
        '0043': -1,
        '0044': settings.maintainAspectRatio,
        '0045': -1,
        'padmode000': [
